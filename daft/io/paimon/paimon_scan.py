...
class PaimonScanOperator(ScanOperator):
    ...
    def to_scan_tasks(self, pushdowns: PyPushdowns) -> Iterator[ScanTask]:
        ...
        pv_cache: dict[tuple[str, ...], daft.recordbatch.RecordBatch | None] = {}
        ...
        for split in plan.splits():
            ...
            if self._use_native_parquet and (not self._table.is_primary_key_table or split.raw_convertible):
                if self._partition_keys:
                    ...
                    cached_pv = pv_cache[pv_key]
                    pv_recordbatch = cached_pv._recordbatch if cached_pv is not None else None
                else:
                    pv_recordbatch = None
